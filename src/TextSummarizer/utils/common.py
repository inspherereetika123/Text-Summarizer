...
def read_yaml(path_to_yaml: Path) -> ConfigBox:
    ...
    Raises:
        ...
        Exception: Any other error during file reading.
...
@typechecked
def create_directories(path_to_directories: List[Any], verbose: bool = True):
    """
    Create multiple directories safely.

    Args:
        path_to_directories (List[Any]): List of directory paths.
